            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "3":
                        ...
                        var member = library.FindMemberById(mid);
                        var book = library.FindBookById(bid);

                        if (member is Member m1 && book != null)
                            m1.BorrowBook(book);
                        else
                    ...
                    case "4":
                        ...
                        if (member is Member m2 && book != null)
                            m2.ReturnBook(book);
                        else
                            Console.WriteLine("Invalid member or book ID.");
                        break;
